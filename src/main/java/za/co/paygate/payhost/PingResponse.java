 ...
 *       &lt;sequence&gt;
 *         &lt;element name="PingFields" type="{http://www.paygate.co.za/PayHOST}KeyValueType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class PingResponse {
    ...
    @XmlElement(name = "PingFields")
    protected List<KeyValueType> pingFields;
    @XmlElement(name = "UserDefinedFields")
    protected List<KeyValueType> userDefinedFields;

    /**
     * Gets the value of the pingFields property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the pingFields property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPingFields().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<KeyValueType> getPingFields() {
        if (pingFields == null) {
            pingFields = new ArrayList<KeyValueType>();
        }
        return this.pingFields;
    }
